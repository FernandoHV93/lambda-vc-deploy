...
from src.controller.f5_tts.model import CFM
from src.controller.f5_tts.model.utils import (
    get_tokenizer,
...
def load_model(
    ...
    if vocab_file == "":
        vocab_file = os.path.join(Configurations.MSNLP_AI_F5TTS_AUDIO_VOCAB_ES)
    tokenizer = "custom"
